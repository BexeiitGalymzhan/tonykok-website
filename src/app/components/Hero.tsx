    ...
    <div className="pb-25 pt-45">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="relative max-w-[89vw] -top-10 md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          >
            Строительство жилых и нежилых объектов, монтаж инженерных систем,
            промышленных зданий и реставрация памятников культуры. Работаем с
            2010 года, обладаем собственной техникой и производственной базой в
            Атырау.
          </motion.p>
        </div>
      </div>
