    ...
    <section id="contact" className="relative pb-20">
      <div className="flex flex-col items-center ">
        ...
        <p className="text-center max-w-2xl mb-17  text-lg">
          ...
          information, or want to discuss how we can work together, our team is
          here to help.
        </p>
        <div className="grid grid-cols-[350px] md:grid-cols-[1fr_2fr] gap-20 ">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a className="hover:text-blue-200">
                    Atyrau, Sultan Beibarys ave, 450
                  </a>
                </div>
              </div>
            </div>
          </div>
          <div className="bg-gray-900 rounded-lg max-w-150 -top-4 relative">
            <h2 className="text-2xl pl-3 py-4 font-semibold">
              We are on the Maps
            </h2>
